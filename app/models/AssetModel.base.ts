...
/**
 * AssetBase
 * auto generated base class for the model AssetModel.
 */
export const AssetModelBase = ModelBase
  .named('Asset')
  .props({
    __typename: types.optional(types.literal("Asset"), "Asset"),
...
export class AssetModelSelector extends QueryBuilder {
...
export function selectFromAsset() {
  return new AssetModelSelector()
}

export const assetModelPrimitives = selectFromAsset().createdAt.fileName.handle.height.mimeType.size.updatedAt.url.width
