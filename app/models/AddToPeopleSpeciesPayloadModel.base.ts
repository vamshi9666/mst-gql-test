...
/**
 * AddToPeopleSpeciesPayloadBase
 * auto generated base class for the model AddToPeopleSpeciesPayloadModel.
 */
export const AddToPeopleSpeciesPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('AddToPeopleSpeciesPayload')
  .props({
    __typename: types.optional(types.literal("AddToPeopleSpeciesPayload"), "AddToPeopleSpeciesPayload"),
...
export class AddToPeopleSpeciesPayloadModelSelector extends QueryBuilder {
...
export function selectFromAddToPeopleSpeciesPayload() {
  return new AddToPeopleSpeciesPayloadModelSelector()
}

export const addToPeopleSpeciesPayloadModelPrimitives = selectFromAddToPeopleSpeciesPayload()
