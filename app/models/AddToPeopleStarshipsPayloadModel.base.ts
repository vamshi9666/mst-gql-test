...
/**
 * AddToPeopleStarshipsPayloadBase
 * auto generated base class for the model AddToPeopleStarshipsPayloadModel.
 */
export const AddToPeopleStarshipsPayloadModelBase = withTypedRefs<Refs>()(ModelBase
  .named('AddToPeopleStarshipsPayload')
  .props({
    __typename: types.optional(types.literal("AddToPeopleStarshipsPayload"), "AddToPeopleStarshipsPayload"),
...
export class AddToPeopleStarshipsPayloadModelSelector extends QueryBuilder {
...
export function selectFromAddToPeopleStarshipsPayload() {
  return new AddToPeopleStarshipsPayloadModelSelector()
}

export const addToPeopleStarshipsPayloadModelPrimitives = selectFromAddToPeopleStarshipsPayload()
